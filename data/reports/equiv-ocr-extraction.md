...
| `equiv-tib-chn-great` | 藏漢大辭典 (dKon-mchog) | 3338 / **2401 (72%)** | **23,236** | 68.6 | Tib→중국어, **부분 — OCR 백그라운드 계속** |
...
equiv-tib-chn-great.jsonl     :  23,236 rows · 15 MB   (PARTIAL — 2401/3338p, 72%)
─────────────────────────────────────────────────────────────────
TOTAL (committed)             : 152,102 rows ·  97 MB
```
