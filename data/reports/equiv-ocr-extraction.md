...
| `equiv-tib-chn-great` | 藏漢大辭典 (dKon-mchog) | 3338 / **3002 (90%)** | **29,255** | 68.5 | Tib→중국어, **부분 — OCR 거의 완료** |
...
equiv-tib-chn-great.jsonl     :  29,255 rows · 19 MB   (PARTIAL — 3002/3338p, 90%)
─────────────────────────────────────────────────────────────────
TOTAL (committed)             : 158,121 rows · 101 MB
```
