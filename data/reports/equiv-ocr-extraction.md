...
| `equiv-turfan-skt-de` | Turfan SWB (Bechert) v1 | 696 / **155 (22%)** | **1,527** | 87.8 | Skt→독일어, **부분 — OCR 백그라운드 계속**, 가장 깨끗 |
| `equiv-tib-chn-great` | 藏漢大辭典 (dKon-mchog) | 3338 / **200 (6%)** | **1,691** | 66.9 | Tib→중국어, **부분 — OCR 백그라운드 계속** |
...
equiv-turfan-skt-de.jsonl     :   1,527 rows · 0.9 MB  (PARTIAL — 155/696p of vol1)
equiv-tib-chn-great.jsonl     :   1,691 rows · 1.0 MB  (PARTIAL — 200/3338p)
─────────────────────────────────────────────────────────────────
TOTAL (committed)             : 120,322 rows ·  75 MB
```
