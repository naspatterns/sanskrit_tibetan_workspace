...
| `equiv-tib-chn-great` | 藏漢大辭典 (dKon-mchog) | 3338 / **2000 (60%)** | **19,195** | 68.7 | Tib→중국어, **부분 — OCR 백그라운드 계속** |
...
equiv-tib-chn-great.jsonl     :  19,195 rows · 12 MB   (PARTIAL — 2000/3338p, 60%)
─────────────────────────────────────────────────────────────────
TOTAL (committed)             : 148,061 rows ·  94 MB
```
