...
| `equiv-tib-chn-great` | 藏漢大辭典 (dKon-mchog) | 3338 / **2601 (78%)** | **25,260** | 68.6 | Tib→중국어, **부분 — OCR 백그라운드 계속** |
...
equiv-tib-chn-great.jsonl     :  25,260 rows · 16 MB   (PARTIAL — 2601/3338p, 78%)
─────────────────────────────────────────────────────────────────
TOTAL (committed)             : 154,126 rows ·  98 MB
```
