...
| `equiv-turfan-skt-de` | Turfan SWB (Bechert) v1 | 696 / **675 (97%)** | **6,559** | 85.4 | Skt→독일어, v1 거의 완료, v2 시작 대기 |
| `equiv-tib-chn-great` | 藏漢大辭典 (dKon-mchog) | 3338 / **600 (18%)** | **5,606** | 68.2 | Tib→중국어, **부분 — OCR 백그라운드 계속** |
...
equiv-turfan-skt-de.jsonl     :   6,559 rows · 4.1 MB  (PARTIAL — 675/696p of vol1)
equiv-tib-chn-great.jsonl     :   5,606 rows · 3.5 MB  (PARTIAL — 600/3338p)
─────────────────────────────────────────────────────────────────
TOTAL (committed)             : 129,269 rows ·  82 MB
```
