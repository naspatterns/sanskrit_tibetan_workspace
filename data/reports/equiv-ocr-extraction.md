...
| `equiv-turfan-skt-de` | Turfan SWB (Bechert) v1 | 696 / **~605 (87%)** | **6,030** | ~85 | Skt→독일어, **부분 — OCR 백그라운드 계속**, 가장 깨끗 |
| `equiv-tib-chn-great` | 藏漢大辭典 (dKon-mchog) | 3338 / **550 (16%)** | **5,169** | 68.0 | Tib→중국어, **부분 — OCR 백그라운드 계속** |
...
equiv-turfan-skt-de.jsonl     :   6,030 rows · 3.8 MB  (PARTIAL — ~605/696p of vol1)
equiv-tib-chn-great.jsonl     :   5,169 rows · 3.3 MB  (PARTIAL — 550/3338p)
─────────────────────────────────────────────────────────────────
TOTAL (committed)             : 128,303 rows ·  81 MB
```
