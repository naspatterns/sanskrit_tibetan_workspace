...
| `equiv-tib-chn-great` | 藏漢大辭典 (dKon-mchog) | 3338 / **2200 (66%)** | **21,206** | 68.6 | Tib→중국어, **부분 — OCR 백그라운드 계속** |
...
equiv-tib-chn-great.jsonl     :  21,206 rows · 13 MB   (PARTIAL — 2200/3338p, 66%)
─────────────────────────────────────────────────────────────────
TOTAL (committed)             : 150,072 rows ·  95 MB
```
